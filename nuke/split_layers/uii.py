...
class SplitLayersUI(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.input_listview.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
        ...
        self.split_listview.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
